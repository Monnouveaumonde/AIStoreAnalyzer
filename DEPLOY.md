# Guide de déploiement — ShopPulseAi
...
git init
git add .
git commit -m "feat: initial ShopPulseAi"
...
export default function PrivacyPolicy() {
  return (
    <html lang="fr">
      <head>
        <meta charSet="utf-8" />
        <title>Politique de confidentialité — ShopPulseAi</title>
      </head>
      <body style={{ fontFamily: "sans-serif", maxWidth: "800px", margin: "40px auto", padding: "0 20px" }}>
        ...
        <p>ShopPulseAi collecte uniquement :</p>
        <ul>
...
export default function Support() {
  return (
    <html lang="fr">
      <head>
        <meta charSet="utf-8" />
        <title>Support — ShopPulseAi</title>
      </head>
      <body style={{ fontFamily: "sans-serif", maxWidth: "800px", margin: "40px auto", padding: "0 20px" }}>
        <h1>Support ShopPulseAi</h1>
...
```
ShopPulseAi analyse votre boutique Shopify en quelques secondes et 
